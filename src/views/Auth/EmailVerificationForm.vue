  ...
  methods: {
    ...
    async resendVerificationCode() {
      ...
      const token = localStorage.getItem(
        "naqla_admin_dashboard_forget_pass_token"
      );
      try {
        ...
        localStorage.setItem(
          "naqla_admin_dashboard_verification_code",
          res.data.body.code
        );
    ...
    async submitForm() {
      ...
      this.$axios.defaults.headers.common["Authorization"] =
        "Bearer " +
        localStorage.getItem("naqla_admin_dashboard_forget_pass_token");
      REQUEST_DATA.append(
        "code",
        this.firstNumber +
          this.secondNumber +
      ...
      if (this.verificationType == "reset-password") {
        try {
          ...
          this.isWaitingRequest = false;
          localStorage.setItem(
            "naqla_admin_dashboard_reset_pass_token",
            res.data?.access_token
          );
          this.$message.success(this.$t("MESSAGES.verifiedSuccessfully"));
          this.clearFormInputs();
          localStorage.removeItem("naqla_admin_dashboard_email");
