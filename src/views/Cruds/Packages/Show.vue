  ...
  methods: {
    ...
    async showPackage() {
      try {
        ...
        this.data.name_ar = res.data.data.Package?.translated_name?.name?.ar;
        this.data.name_en = res.data.data.Package?.translated_name?.name?.en;
        this.data.number_of_sessions = res.data.data.Package?.lecture_numbers;
        this.data.price = res.data.data.Package?.price;
        this.data.image.path = res.data.data.Package?.image;
        this.data.is_active = res.data.data.Package?.status;
        console.log("bbb", this.data.is_active);
        this.data.type = res.data.data.Package?.type;

        if (this.data.type == "shadow_teacher_package") {
          this.data.type = {
            id: 1,
